...
def send_waste_data(data, supabase_url, supabase_key, location="Lab Analysis"):
    ...
    Example:
        ...
        send_waste_data(waste_results, SUPABASE_URL, SUPABASE_KEY)
...
if __name__ == "__main__":
    # Your teammate's actual Supabase credentials (you provide these)
    SUPABASE_URL = "https://your-project.supabase.co"  # You give them the real URL
    SUPABASE_KEY = "your-anon-key"  # You give them the real key
